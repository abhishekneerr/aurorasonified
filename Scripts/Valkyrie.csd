...
;*****************************
; Setup for partikkel upcode by Øyvind Brandtsegg:
;*****************************
...
a1,a2,a3,a4,a5,a6,a7,a8 partikkel \ ; (beginner)
 ...
 ;; Amplitude modulation: NOT IMPLEMENTED
...
; Chorus:
;*****************************
 kChorusMix = (kBt_max)^0.7*0.5
 kChorusOffset = (kBt_med^3*20)+0.01
 kChorusRate = kBt_med^2*5+0.1
 kChorusDepth = (kBt_min^3*kChorusOffset)+0.01
 iChorusTable = giSine
  aDelayTime1 oscili 0.5, kChorusRate, iChorusTable, 0
  aDelayTime2 oscili 0.5, kChorusRate, iChorusTable, .5
  aDelayTime1 = ((aDelayTime1+0.5)*kChorusDepth)+kChorusOffset
  aDelayTime2 = ((aDelayTime2+0.5)*kChorusDepth)+kChorusOffset
...
;*****************************
 ...
 iSustain = i(kSustain)
 iRelease = iAttack*4
 if (iAttack == 0) then ;; csound needs two passes to write to the i-variables.
    reinit adsr
 endif
...
;*****************************
; Reverb: (values are sent to mix instrument)
;*****************************
...
;******************************************************************************************************
;******************************************************************************************************
instr 100  ;; mix, phaser and reverb
...
;*****************************
 ...
 aPhaserL Phaser a1,kPhaserFr,kPhaserSharpness
 aPhaserR Phaser a2,kPhaserFr,kPhaserSharpness
 aPhaserL *= kPhaserScale
 aPhaserR *= kPhaserScale
 aPhaserL Phaser aPhaserL,kPhaserFr*2,kPhaserSharpness
 aPhaserR Phaser aPhaserR,kPhaserFr*2,kPhaserSharpness
 aPhaserL *= kPhaserScale
 aPhaserR *= kPhaserScale
 aPhaserL Phaser aPhaserL,kPhaserFr*4,kPhaserSharpness
 aPhaserR Phaser aPhaserR,kPhaserFr*4,kPhaserSharpness
 aPhaserL *= kPhaserScale
 aPhaserR *= kPhaserScale
 aPhaserL Phaser aPhaserL,kPhaserFr*8,kPhaserSharpness
 aPhaserR Phaser aPhaserR,kPhaserFr*8,kPhaserSharpness
 aPhaserL *= kPhaserScale
 aPhaserR *= kPhaserScale
